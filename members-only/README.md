...
## Project 2: [Members Only!](http://www.theodinproject.com/ruby-on-rails/authentication)
...
This is obviously a somewhat incomplete solution... We currently need to create new users from the Rails console.  But it should give you some practice figuring out authentication.  Feel free to improve it... maybe you'll be the next SnapChat.# [Members Only!](http://www.theodinproject.com/ruby-on-rails/authentication)
In this project, you'll be building an exclusive clubhouse where your members can write embarrassing posts about non-members.
...
#[see it now](https://sleepy-citadel-6281.herokuapp.com/) 
